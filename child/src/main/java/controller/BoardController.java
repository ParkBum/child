...
public class BoardController {
	...
	public ModelAndView list(Integer bType, Integer pageNum, String searchType, String searchContent) {
		...
		int listcount = service.boardCount(bType, searchType, searchContent);
		List<Board> boardlist = service.boardList(bType, searchType, searchContent, pageNum, limit);
